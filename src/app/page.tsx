        ...
        <div className=' grid md:grid-cols-2 space-x-5 md:w-[1200px] items-stretch align-middle rounded-3xl'>
          <div className='flex flex-col items-start justify-center space-y-5 w-[75%]'>
            ...
            <div className='flex flex-wrap gap-6'>
              <input value={"Family"} type='button' className={`py-3 px-6 ${`text-Arambo-White bg-Arambo-Accent`} rounded-full`} />
              <input value={"Women"} type='button' className={`py-3 px-6 ${`text-Arambo-Black bg-Arambo-Background`} rounded-full`} />
              <input value={"Bachelor"} type='button' className={`py-3 px-6 ${`text-Arambo-Black bg-Arambo-Background`} rounded-full`} />
              <input value={"Furnished"} type='button' className={`py-3 px-6 ${`text-Arambo-Black bg-Arambo-Background`} rounded-full`} />
              <input value={"Non-Furnished"} type='button' className={`py-3 px-6 ${`text-Arambo-White bg-Arambo-Accent`} rounded-full`} />
            </div>
          </div>
        ...
        <div className='bg-Arambo-Background rounded-2xl md:w-[1200px] flex justify-center'>
          <div className='md:w-[1112px] py-8 px-5 space-y-16 flex flex-col justify-center' >
            <div className='grid md:grid-cols-2 grid-cols-1'>
              <div>
                <h2 className='h2 pr-3'>Know Your Property’s
                  True Worth</h2>
              </div>
