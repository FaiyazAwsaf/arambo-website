...
const page = () => {
    return (
        <div className="space-y-24 bg-Arambo-Background">
            <section className=" py-25 px-4 flex flex-col justify-center items-center space-y-6 rounded-2xl text-center bg-[linear-gradient(180deg,#000B26_0%,#00123C_19.69%,#032471_70.33%,#0C39A3_86.64%,#0041D9_100%)]">
            ...
            <section className="max-w-6xl mx-auto flex flex-col justify-center items-center space-y-7">
                <Link href={"/agent-details"}><AgentCard /></Link>
                <Link href={"/agent-details"}><AgentCard /></Link>
                <Link href={"/agent-details"}><AgentCard /></Link>
            </section>
            <section className="px-4  bg-Arambo-White w-full flex justify-center items-center py-24">
                <KnowYourProperty />
            </section>
        </div>
    )
