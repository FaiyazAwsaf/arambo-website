...
const page = () => {
    return (
        <div className="px-4 space-y-24 bg-Arambo-Background">
            <section className=" py-25 px-5 flex flex-col justify-center items-center space-y-6 rounded-2xl text-center bg-[linear-gradient(180deg,#000B26_0%,#00123C_19.69%,#032471_70.33%,#0C39A3_86.64%,#0041D9_100%)]">
