...
const HyperFiltering = () => {
    ...
    const categories = [{ value: "Family", link: "/family" }, { value: "Women", link: "/women" }, { value: "Bachelor", link: "/bachelor" }, { value: "Furnished", link: "/furnished" }, { value: "Non-Furnished", link: "/non-furnished" }];
    return (
