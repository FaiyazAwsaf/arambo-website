        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-[1200px] px-2 md:px-0">
                    ...
                    {buttonLabels.map((label, index) => (
                        ...
                        >
                            ...
                            <svg width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1.5L7 7.5L1 13.5" stroke={userIndex === index ? "white" : "black"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    ))}
                </div>
            ...
            <div>
                <div className="w-full space-y-2 mt-8 md:mt-0">
                    {[0, 1, 2, 3].map((stepIdx) => (
                        <div key={stepIdx} className="py-8 px-6 space-x-5 flex bg-[#1946BB14] rounded-2xl">
                ...
                <Link href="/#" className="space-x-2 flex items-center pt-8">
